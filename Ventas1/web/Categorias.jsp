<%-- 
    Document   : Categorias
    Created on : 25/05/2013, 09:35:42 AM
    Author     : alumnos
--%>
...
<div class="center_content">  
         ...
         <div class="right_content" style="width:900px;">            
             ...
             <div class="EmpCajaFil" style="width:900px">
                 <div class="EmpCajaLbl"><span id="">CATEGORÍA(S):</span></div>
	...
	<table class="grid" cellspacing="0" rules="all" border="1" id="" style="width:900px;border-collapse:collapse;">
		<caption>
			...
			<th scope="col">&nbsp;</th><th align="center" scope="col">Id</th><th align="center" scope="col">Categoría</th>
		</tr><tr>
			<td align="center" style="width:5%;"><a href="#">+</a></td><td align="center" style="width:2%;">12</td><td align="left" style="width:20%;">CALZADO</td>
		</tr><tr class="altrow">
			<td align="center" style="width:5%;"><a href="#">+</a></td><td align="center" style="width:2%;">3</td><td align="left" style="width:20%;">ROPA</td>
		</tr><tr>
			<td align="center" style="width:5%;"><a href="#">+</a></td><td align="center" style="width:5%;">23</td><td align="left" style="width:20%;">PROTECTORES</td>
		</tr>
        <tr class="pagerstyle">
			<td colspan="10">
            ...
            <div style="float:left; width:100px; height:30px;"><input type="submit" name="" value="+ Categoría" id="" style="width:90px;" /></div>
