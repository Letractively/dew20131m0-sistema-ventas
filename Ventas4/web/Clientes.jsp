...
<%@page import="ventas.com.beans.BeanClientes"%>
<%@page import="ventas.com.entity.Cliente"%>
...
<div class="center_content">  
	...
	<table class="grid" cellspacing="0" rules="all" border="1" id="" style="width:900px;border-collapse:collapse;">
		<caption>
			...
			<td align="center" style="width:5%;"><a href="">+</a></td><td align="center" style="width:2%;">240</td>
                        <td align="left" style="width:30%;">CMAC - HUANCAYO S.A.</td>
                        <td align="left" style="width:30%;">OFICINA PRINCIPAL CALLE REAL N&#186; 341 / 343</td>
                        <td align="center" style="width:10%;">20130200789</td>
			...
			<td colspan="10">
				...
				<option value="2">2</option>
                    ...
                    <%
                        if (session.getAttribute("clientesupc") != null) {
                            //BeanClientes cabe = (BeanClientes) session.getAttribute("clientesupc");
...
///               listaClientes = clie.getLista();
                            ...
                            ///List listDetalle = cabe.getLista();
                            List listDetalle = (List)request.getSession().getAttribute("clientesupc"); 

                            for (int i = 0; i < listDetalle.size(); i++) {
                                Cliente det = (Cliente) listDetalle.get(i);

                    %>
                    
                    <tr>
                        <td align="center" style="width:5%;"><a href="">+</a></td>
                        <td align="center" style="width:5%;"><%=det.getId()%> </td>
                        <td align="left" style="width:30%;"><%=det.getNombre()%> </td>
                        <td align="left" style="width:30%;"><%=det.getDireccion() %></td>
                        <td align="center" style="width:10%;"><%=det.getRuc() %></td>
                        <td align="center" style="width:8%;"><%=det.getTelefono() %></td>
                    </tr>
                    <% }
                        }%>
