<%-- 
    Document   : ClientesRegistro
    Created on : 25/05/2013, 10:31:43 AM
    Author     : alumnos
--%>
...
<div class="center_content">  
    ...
    <div class="right_content"> 
        <div class="EmpCajaLbl" style="width:70px;"><span id="ContentPlaceHolder1_Label7" class="EmpEtiquetas">CLIENTE:</span></div>
        <div class="EmpCajaLbl"><strong><span id="ContentPlaceHolder1_Label17" class="EmpEtiquetas" style="display:inline-block;width:700px;">NUEVO</span></strong></div>
	...
	<div id="ContentPlaceHolder1_TabContainer2_header" class="ajax__tab_header">
        ...
        <span class="ajax__tab_outer"><span class="ajax__tab_inner">
		...
		<div id="ContentPlaceHolder1_TabContainer2_TabPanel1" id="ContentPlaceHolder1_TabContainer2_TabPanel1" class="ajax__tab_panel">
                    ...
                    <div style="float:left; width:880px; min-height:260px; height:auto;">
                        <div class="Fila800Vacio"></div>

                        <div class="EmpCajaFil" style="width:700px"> 
                        ...
                        <div class="EmpCajaCol" style="width:280px;">
                            ...
                            <div class="EmpCajaFil">
                                ...
                                <div class="EmpCajaTxt"><input name="ctl00$ContentPlaceHolder1$TabContainer2$TabPanel1$txtTelefono" type="text" maxlength="50" id="ContentPlaceHolder1_TabContainer2_TabPanel1_txtTelefono" class="EmpTextos" style="width:140px;" /></div>
                            </div>

                            <div class="EmpCajaFil">
                                <div class="EmpCajaLbl"><span id="ContentPlaceHolder1_TabContainer2_TabPanel1_Label20" class="EmpEtiquetas">EMAIL:</span></div>
                                <div class="EmpCajaTxt2"><input name="ctl00$ContentPlaceHolder1$TabContainer2$TabPanel1$txtEmail" type="text" maxlength="50" id="ContentPlaceHolder1_TabContainer2_TabPanel1_txtEmail" class="EmpTextos" style="width:140px;" /></div>
                            </div>

                            <div class="EmpCajaFil">
                                <div class="EmpCajaLbl"><span id="ContentPlaceHolder1_TabContainer2_TabPanel1_Label16" class="EmpEtiquetas">ANIVERSARIO:</span></div>
                                <div class="EmpCajaTxt2">
                                    <input name="ctl00$ContentPlaceHolder1$TabContainer2$TabPanel1$txtAniversario" type="text" id="ContentPlaceHolder1_TabContainer2_TabPanel1_txtAniversario" class="EmpTextos" style="width:80px;" />
                                    
                                    <img id="ContentPlaceHolder1_TabContainer2_TabPanel1_imgCalendar" src="../images/calendario.png" />
                                    <input type="hidden" name="ctl00$ContentPlaceHolder1$TabContainer2$TabPanel1$txtAniversario_MaskedEditExtender_ClientState" id="ContentPlaceHolder1_TabContainer2_TabPanel1_txtAniversario_MaskedEditExtender_ClientState" />
                                    <span id="ContentPlaceHolder1_TabContainer2_TabPanel1_MaskedEditValidator1" style="display:none;">Mensaje</span>
                                </div>
                            </div>
                        ...
                        <div class="EmpCajaCol2" style="margin-left:10px;">
                                

                        </div>

                        <div class="EmpCajaCol2" style="margin-left:10px; width:310px;">
        ...
        <div class="Fila800Vacio" style="width:900px;">
            ...
            <div style="float:left; width:100px; height:30px;"><input type="submit" name="btnGrabar" value="Grabar" onclick="" class="submit" style="width:90px;" /></div>
            <div style="float:left; width:100px; height:30px;"><input type="submit" name="btnCancelar" value="Cancelar" onclick="" class="submit" style="width:90px;" /></div>
        </div>                
